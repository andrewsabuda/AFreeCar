...
public class PartConnectionsInfoTest {
    ...
    private static final Terminal[] TERMINAL_INFOS = initializeTerminalInfos();
    ...
    public void setUp() throws Exception {
        testPartConnInfo = new PartConnectionsInfo(NEEDS_CHASSIS_CONN, new HashSet<Terminal>(Arrays.asList(TERMINAL_INFOS)));
    }
    ...
    public void getTerminalIDsMap() {
        ...
        for (Terminal termInfo: TERMINAL_INFOS) {
    ...
    public void testEquals() {
        assertEquals(new PartConnectionsInfo(NEEDS_CHASSIS_CONN, new HashSet<Terminal>(Arrays.asList(TERMINAL_INFOS))), testPartConnInfo);
    }
